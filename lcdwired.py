...
def main(mylcd):
    ...
    while True:
      # Send some test
      mylcd.lcd_string("Rasbperry Pi",1)
      mylcd.lcd_string("16x2 LCD Test",2)
  
      time.sleep(3) # 3 second delay
  
      # Send some text
      mylcd.lcd_string("1234567890123456",1)
      mylcd.lcd_string("abcdefghijklmnop",2)
  
      time.sleep(3) # 3 second delay
  
      # Send some text
      mylcd.lcd_string("RaspberryPi-spy",1)
      mylcd.lcd_string(".co.uk",2)
  
      time.sleep(3)
  
      # Send some text
      mylcd.lcd_string("Follow me on",mylcd.LCD_LINE_1)
      mylcd.lcd_string("Twitter @RPiSpy",mylcd.LCD_LINE_2)
  
      time.sleep(3)
    #   print(mylcd.LCD_LINE_1,mylcd.LCD_LINE_2)
